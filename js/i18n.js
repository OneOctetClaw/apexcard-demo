...
const TRANSLATIONS = {
  fr: {
    ...
    'app.documents.sub': 'Relevés & attestations officielles',
    'app.documents.stmt_title': 'Relevé de compte',
    'app.documents.attest_title': 'Attestation bancaire',
    'app.documents.filter.all': 'Tout',
    'app.documents.filter.card': 'Carte',
    'app.documents.filter.affiliate': 'Affilié',
  ...
  en: {
    ...
    'app.nav.documents': 'Documents',
    'app.documents.title': 'Documents',
    'app.documents.sub': 'Statements & official letters',
    'app.documents.stmt_title': 'Account Statement',
    'app.documents.attest_title': 'Bank Confirmation Letter',
    'app.documents.filter.all': 'All',
    'app.documents.filter.card': 'Card',
    'app.documents.filter.affiliate': 'Affiliate',
